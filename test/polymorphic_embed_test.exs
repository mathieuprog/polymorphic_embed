defmodule PolymorphicEmbedTest do
  ...
  test "receive embed as map of values" do
    for generator <- @generators do
      ...
      sms_changeset =
        Ecto.Changeset.change(sms_module)
  ...
  test "cannot generate IDs if struct didn't go through cast_polymorphic_embed/3" do
    ...
    reminder =
      ...
      assert_raise RuntimeError, ~r"polymorphic_embed is not able to add an autogenerated key without casting through cast_polymorphic_embed/3", fn ->
